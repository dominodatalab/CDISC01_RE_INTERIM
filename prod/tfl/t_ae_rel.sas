...
ods pdf file = "/mnt/artifacts/results/t_ae_rel.pdf"
		style = newstyle;
...
proc report data = final headline split = "*" 
        ...
        ** add footnotes;
        ...
        footnote5 justify = left "Dataset(s): ADAE; Program: t_ae_rel.sas; Output: t_ae_rel.pdf; Generated on: &sysdate9 &systime";
run;
