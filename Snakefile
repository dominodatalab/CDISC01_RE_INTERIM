...
rule ADAE:
    input:
        ...
        "/mnt/imported/data/snapshots/SDTMBLIND/MAY092023/ae.sas7bdat",
        "/mnt/imported/data/snapshots/SDTMBLIND/MAY092023/ex.sas7bdat",
        "/mnt/data/ADAM/adsl.sas7bdat"
    output:
        "/mnt/data/ADAM/adae.sas7bdat"
    log:
...
rule ADCM:
    input:
        ...
        "/mnt/imported/data/snapshots/SDTMBLIND/MAY092023/cm.sas7bdat",
        "/mnt/data/ADAM/adsl.sas7bdat"
    output:
        "/mnt/data/ADAM/adcm.sas7bdat"
    log:
...
rule ADLB:
    input:
        ...
        "/mnt/imported/data/snapshots/SDTMBLIND/MAY092023/lb.sas7bdat",
        "/mnt/data/ADAM/adsl.sas7bdat"
    output:
        "/mnt/data/ADAM/adlb.sas7bdat"
    log:
...
rule ADMH:
    input:
        ...
        "/mnt/imported/data/snapshots/SDTMBLIND/MAY092023/mh.sas7bdat",
        "/mnt/data/ADAM/adsl.sas7bdat"
    output:
        "/mnt/data/ADAM/admh.sas7bdat"
    log:
...
rule ADSL:
    input:
        ...
        "/mnt/imported/data/snapshots/SDTMBLIND/MAY092023/dm.sas7bdat"
    output:
        "/mnt/data/ADAM/adsl.sas7bdat"
    log:
...
rule ADVS:
    input:
        ...
        "/mnt/imported/data/snapshots/SDTMBLIND/MAY092023/vs.sas7bdat",
        "/mnt/data/ADAM/adsl.sas7bdat"
    output:
        "/mnt/data/ADAM/advs.sas7bdat"
    log:
